        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-3">
            ...
            <main className="flex-grow container mx-auto px-4 py-8 flex flex-col md:flex-row">
                <article className="md:w-2/3 md:pr-8">
                  ...
                  <p>
                    Andrew Zimmern, a lifelong outdoorsman and chef, is heading back into the wild
                    to source his favorite proteins. From wild pigs in Oklahoma to redfish in
                    Louisiana, Field to Fire will showcase the incredible wild feasts the field has
                    to offer.
                  </p>
                </article>
              </main>
