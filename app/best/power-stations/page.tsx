...
function getHubCards(): HubCard[] {
  const solar = dedupeBySlug([...getStationsByFeature('solar'), ...getStationsByFeature('solar-kit')]);

  return [
    { title: 'Portable Power Stations', description: 'Versatile power stations for camping, emergencies, and outdoor activities', href: '/best/power-stations/portable-power-stations', count: 7, priceRange: '$429 – $3,699', features: ['500Wh – 1,500Wh', 'Multiple ports', 'Solar charging', 'Portable design'] },
    { title: 'House Backup Power Stations', description: 'High-capacity units for whole-home backup during outages', href: '/best/power-stations/house-backup-power-stations', count: 4, priceRange: '$1,199 – $7,699', features: ['3,000Wh+', 'Home integration', '240V capable', 'Extended runtime'] },
    { title: 'RV Power Stations', description: 'Power stations with genuine 30A outlets and solar charging for RV and trailer use', href: '/best/power-stations/rv-power-stations', ...summarizeStations(getStationsByFeature('30a-rv')), features: ['30A RV outlet', 'Solar ready', 'High capacity', 'Expandable'] },
    { title: 'Solar Generators', description: 'High solar input units for off-grid and solar-primary setups', href: '/best/power-stations/solar-generators', ...summarizeStations(solar), features: ['800W+ solar', 'LiFePO4 battery', 'Off-grid ready', 'MPPT charging'] },
    { title: 'Camping Power Stations', description: 'Compact and lightweight power solutions for outdoor adventures', href: '/best/power-stations/camping-power-stations', count: 5, priceRange: '$199 – $999', features: ['200Wh – 1,000Wh', 'Ultra-portable', 'Weather resistant', 'Silent operation'] },
    { title: 'Van Life Power Stations', description: 'Compact, solar-capable units under 30 lbs built for life on the road', href: '/best/power-stations/van-life', ...summarizeStations(getStationsByFeature('van-life')), features: ['Under 30 lbs', 'Solar capable', 'Compact', 'DC output'] },
    { title: 'Under $500', description: 'Best portable power stations for every budget under $500', href: '/best/power-stations/under-500', ...summarizeStations(getStationsUnderPrice(500)), features: ['Budget friendly', 'Essential features', 'Portable', 'Reliable brands'] },
    { title: 'Under $1,000', description: 'Mid-range power stations offering the best value per dollar', href: '/best/power-stations/under-1000', ...summarizeStations(getStationsUnderPrice(1000)), features: ['Best value', 'Mid-range', '500Wh – 2,000Wh', 'Expert picks'] },
    { title: '240V Power Stations', description: 'Power stations with split-phase 240V output for dryers, AC, and EV charging', href: '/best/power-stations/240v-power-stations', ...summarizeStations(getStationsByFeature('240v')), features: ['240V output', 'Split-phase', 'Heavy loads', 'Home backup'] },
    { title: 'CPAP Power Stations', description: 'Quiet, lightweight power stations with enough capacity for overnight CPAP use', href: '/best/power-stations/for-cpap', ...summarizeStations(getStationsByFeature('cpap')), features: ['500–1,500Wh', 'Quiet operation', 'DC mode', 'Compact'] },
      ...
      <div className="bg-gradient-to-br from-primary to-primary-dark px-6 py-10 text-white">
        <div className="mx-auto max-w-content">
          ...
          <p className="mt-2 max-w-2xl text-base text-white/80">
            Expert-tested portable power solutions for every need and budget. {totalReviewed} models reviewed for performance, reliability, and value.
          </p>
          <div className="mt-4 flex flex-wrap gap-2">
            {[`${totalReviewed} Models Reviewed`, 'Real-World Performance', 'All Budgets Covered'].map((tag) => (
