...
export const metadata: Metadata = {
  ...
  description:
    'The best headphones and wireless earbuds for every listener. Expert tested noise-cancelling headphones, gaming headsets, and true wireless earbuds.',
};
...
const headphones: HeadphoneEntry[] = [
  {
    ...
    summary:
      'Industry-leading active noise cancellation with exceptional sound quality, 30-hour battery, and premium comfort for all-day wear.',
    score: 9.3,
    price: '$349',
  ...
  },
  {
    ...
    summary:
      'The best true wireless earbuds with world-class ANC, hi-res audio support, and a dramatically improved compact design.',
    score: 9.3,
    price: '$279',
  ...
  },
  {
    ...
    summary:
      "Apple's H2 chip delivers best-in-class ANC for iOS users, Personalized Spatial Audio, and seamless ecosystem integration.",
    score: 9.2,
    price: '$249',
    specs: {
      Chip: 'Apple H2',
  ...
  },
  {
    ...
    summary:
      'CustomTune personalized ANC, Immersive Audio spatial sound, and a hard-shell case with Qi wireless charging at $299.',
    score: 9.2,
    price: '$299',
    specs: {
      Driver: '35mm TriPort',
  ...
  },
  {
    ...
    summary:
      "Apple's over-ear flagship with computational audio, Personalized Spatial Audio, and premium aluminum build — the ultimate for Apple ecosystem users.",
    score: 9.1,
    price: '$549',
    specs: {
      Chip: 'Apple H1 x2',
  ...
  },
  {
    ...
    summary:
      'MultiSensor Voice technology delivers the best call quality of any earbud, with Dolby Atmos spatial audio and a comfortable open-canal ComfortFit design.',
    score: 9.0,
    price: '$249',
    specs: {
      Driver: '10mm',
  ...
  },
  {
    ...
    summary:
      '60-hour best-in-class battery life with audiophile-grade 42mm drivers, aptX Adaptive codec, and a built-in Tile tracker.',
    score: 8.9,
    price: '$279',
    specs: {
      Driver: '42mm',
  ...
  },
  {
    ...
    summary:
      "The XM5's predecessor remains competitive with wider codec support (LDAC + aptX HD), compact 3-axis fold, and excellent value at its current price.",
    score: 8.9,
    price: '$248',
    specs: {
      Driver: '40mm',
  ...
  },
  {
    ...
    summary:
      "Samsung's flagship earbuds with blade-style design, intelligent ANC, and deep Galaxy ecosystem integration for Android users.",
    score: 8.8,
    price: '$249',
    specs: {
      Driver: '10.5mm',
  ...
  },
  {
    ...
    summary:
      'Custom Tensor A1 chip powers Gemini AI integration, Conversation Detection, and Live Translate — the most intelligent earbuds for Android users.',
    score: 8.8,
    price: '$229',
    specs: {
      Chip: 'Tensor A1',
  ...
  },
  {
    ...
    summary:
      'Classic Bose comfort and reliable ANC performance in a lightweight foldable design — still a strong choice at its reduced street price.',
    score: 8.7,
    price: '$279',
  ...
  },
  {
    ...
    summary:
      'Stylish transparent design with impressive ANC, LHDC 5.0 hi-res codec, and premium performance at a mid-range price.',
    score: 8.7,
    price: '$149',
    specs: {
      Driver: '11.6mm',
  ...
  },
  {
    ...
    summary:
      '40-hour battery, USB-C lossless audio, and dual Apple Find My / Google Find My Device compatibility — the best cross-platform wireless headphone.',
    score: 8.6,
    price: '$349',
    specs: {
      Driver: '40mm',
  ...
  },
  {
    ...
    summary:
      'MIL-STD-810H military-grade durability, IP68 full waterproofing, ShakeGrip secure sport fit, and 6-mic wind-resistant call quality at $149.',
    score: 8.5,
    price: '$149',
    specs: {
  ...
  },
  {
    ...
    summary:
      'Exceptional value with solid ANC, 50-hour battery, and Hi-Res Audio certification at a budget-friendly $79 price point.',
    score: 8.2,
    price: '$79',
...
const categoryLinks = [
  {
    href: '/best/headphones/top-5-wireless-headphones',
        ...
        <div className="bg-gradient-to-br from-primary-lightest via-white to-neutral-50 px-6 py-10">
          <div className="mx-auto max-w-content">
            ...
            <h1 className="mt-4 max-w-3xl font-display text-4xl font-semibold tracking-tight text-neutral-900 md:text-5xl">
              Best Headphones & Earbuds 2025
            </h1>
            <p className="mt-3 max-w-3xl text-base leading-relaxed text-neutral-600">
              Expert-tested headphones and earbuds for audiophiles, commuters, gamers, and everyday
              listeners. Find the perfect pair for your lifestyle.
            </p>
            ...
            <div className="rounded-xl bg-gradient-to-br from-primary-lightest to-primary-light/20 p-6">
              ...
              <div className="grid grid-cols-1 gap-4 sm:grid-cols-3">
                {[
                  {
                    title: 'Sound Quality',
                    desc: 'Frequency response, soundstage, detail retrieval, and tonal balance across genres of music and content types.',
                  },
                  {
                    title: 'ANC Performance',
                    desc: 'Measured noise attenuation across low, mid, and high frequencies in real-world environments like planes and offices.',
                  },
                  {
                    title: 'Comfort & Build',
                    desc: 'Long-wear comfort assessment, build quality, eartip fit (earbuds), clamping force, and materials durability.',
                  },
                ].map((item) => (
                  <div key={item.title}>
