...
specs:
  ...
  Sound Stage: "360-degree audio with computational audio"
  Connectivity: "Wi-Fi 802.11n (2.4GHz/5GHz), Bluetooth 5.0"
  Special Chips: "Ultra Wideband (U1), Thread border router"
  Smart Features: "Intercom, Handoff, HomePod stereo pair"
  Power: "USB-C (cable included, adapter sold separately)"
  Height: "3.3 inches"
  Weight: "0.76 lbs"
  Price: "$99"

pros:
  - "360-degree audio fills a room impressively for its small physical footprint"
  - "Thread border router support future-proofs smart home device compatibility"
  - "Ultra Wideband chip enables precise spatial audio handoff with iPhone"
  - "Intercom feature works seamlessly across all Apple devices in the home"
  - "Privacy-focused design processes Siri requests on-device where possible"

cons:
  - "Siri lags behind Alexa and Google Assistant in third-party knowledge and skills"
  - "Requires an Apple ID and iPhone for initial setup—Android users cannot use it"
  - "No 3.5mm aux input or line-in option"
