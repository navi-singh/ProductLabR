...
specs:
  ...
  Audio Processing: "Dolby Audio processing"
  Smart Assistant: "Alexa"
  Connectivity: "Wi-Fi 802.11a/b/g/n/ac (dual-band), Bluetooth 5.0"
  Smart Home Hub: "Zigbee, Matter, Thread, Sidewalk"
  Microphones: "7-microphone array with far-field voice recognition"
  Power: "AC adapter (included)"
  Dimensions: "5.7 x 5.7 x 5.2 inches (spherical)"
  Price: "$99"

pros:
  - "Built-in Zigbee hub eliminates the need for a separate smart home bridge for most devices"
  - "Alexa has the widest third-party smart home device and skill compatibility of any voice assistant"
  - "Significantly improved audio quality over previous Echo generations—full sound with real bass"
  - "7-microphone far-field array picks up voice commands reliably from across the room with music playing"
  - "Matter and Thread support future-proofs the device for next-generation smart home standards"

cons:
  - "Alexa's general knowledge responses lag behind Google Assistant in accuracy and depth"
  - "Amazon collects and processes voice data by default—privacy-conscious users require configuration"
  - "Spherical design is larger than competing speakers at the same price"
  - "Alexa Guard and premium features require an Amazon subscription tier for full functionality"
