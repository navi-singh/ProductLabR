...
pros:
  ...
  - "50-minute charge time to 80% with AC input"
  - "IP65-rated battery for dust and water resistance"
  - "Excellent app and digital display for monitoring/control"
  - "Rugged wheels and telescoping handle for easier transport"
  - "10ms UPS mode for critical devices"
  - "Quiet operation, no fumes"
  - "Expandable and integrates with EcoFlow Smart Home Panel 2"
cons:
